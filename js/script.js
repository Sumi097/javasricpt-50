...
// bulb on/ off 
function bulbOn(){
    document.getElementById('b_img').src="image/pic_bulbon.gif on.gif";
}
function bulbOff(){
    document.getElementById('b_img').src="image/pic_bulboff (1).gif";
}

// smile/engry 
function smile(){
    document.getElementById('emoji').src="image/pngwing.com (1).png";
}
function engry(){
    document.getElementById('emoji').src="image/pngwing.com.png";
}
// document.write 
function d_write(){
...
function event4(){
    document.getElementById('smile_ev').src="image/emoji2.png";
}
function event5(){
    document.getElementById('smile_ev').src="image/emoji.png";
}
